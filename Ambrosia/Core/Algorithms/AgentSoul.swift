...
struct AgentSoul {
    ...
    static func hostModeratorCommandments(restaurantName: String, requiredDishes: Int) -> String {
        ...
        5. THE GAVEL: You must actively track the proposed dishes. If you see the Delegates have agreed on \(requiredDishes) safe dishes that DO NOT violate anyone's vetoes, you MUST send exactly this string: "[CONSENSUS REACHED]" followed by the final \(requiredDishes) dish names. This exact string triggers a system shutdown.
        """
    }
